...
# --- BAGIAN INTI PERBAIKAN ---
# 1. Kita buat 3 kolom: kolom kiri dan kanan sebagai spasi, dan kolom tengah untuk konten.
# Angka [1, 2, 1] adalah perbandingan lebarnya. Anda bisa ubah jika perlu.
left_spacer, main_content, right_spacer = st.columns([1, 2, 1])

# 2. Semua konten dimasukkan ke dalam kolom 'main_content'
with main_content:
    # === JUDUL HALAMAN ===
