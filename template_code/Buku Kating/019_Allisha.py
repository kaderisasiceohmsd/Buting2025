    ...
    def kesekjenan():
        ...
        data_list = [
            ...
            },
            {
                ...
                "kesan": "Selalu ramah dan seru diajak ngobrol",  
...
if menu == "Baleg":
    def baleg():
        gambar_urls = [
            ...
            "https://drive.google.com/uc?export=view&id=192-viOSmxlkmSFdm9HHr3af8he0j0yW_",
...
if menu == "Departemen MIKFES":
    def mikfes():
        gambar_urls = [
            ...
            "https://drive.google.com/uc?export=view&id=1LDo5geAH9KJSIxY_FDFpiO6Grcl4kTfc",
        ...
        data_list = [
            ...
            },
            {
                ...
                "sosmed": "@Junitaa.0406",
                "kesan": "Ramah, ceria, dan selalu membawa suasana positif",  
                "pesan":"Jangan pernah berhenti berusaha untuk mencapai cita-cita."# 1
            },
            {
                ...
                "hobbi": "dengerin musik",
                "sosmed": "@mregiiii_",
                "kesan": "Asik, Humoris, dan selalu bisa mencairkan suasana",  
                "pesan":"Teruslah jadi pribadi yang rendah hati dan tetap semangat mengejar impian"# 1
            },
            {
                ...
                "hobbi": "Maskeran",
                "sosmed": "@_aishsahi",
                "kesan": "Baik hati, lembut dan penyabar",  
                "pesan":"Tetaplah jadi sosok yang rendah hati dan penuh semangat"# 1
            },
            {
                ...
                "kesan": "Seru, lucu, dan mudah beradaptasi.",  
                "pesan":"Tetaplah jadi orang yang asik dan penuh semangat"# 1
            },
            {
                ...
                "kesan": "Ceria dan humoris.",  
                "pesan":"Tetaplah jadi sumber tawa di setiap suasana."# 1
            },
            {
                ...
                "hobbi": "Dengerin Musik",
                "sosmed": "@notfall.s",
                "kesan": "Penuh tanggung jawab, dan punya semangat tinggi",  
                "pesan":"Semoga ke depannya semakin sukses, terus berkembang, dan tetap jadi pribadi yang menginspirasi banyak orang."# 1
            },
            {
                ...
                "hobbi": "Menonton Film",
                "sosmed": "@adiaafrj",
                "kesan": "Ramah, lembut dan enak diajak bicara.",  
                "pesan":"Semoga semua impian kakak tercapai dan tetap dikelilingi hal-hal yang bikin bahagia"# 1
            },
            {
            ...
            },
            {
                ...
                "hobbi": "Tidur",
                "sosmed": "@tunty_i",
                "kesan": "Baik, ramah, dan selalu punya aura positif",  
                "pesan":"Tetaplah bersinar seperti bintang"# 1
            },
            {
                "nama": "Eggi Satria",
                "nim": "122450032",
                ...
                "hobbi": "Tidur",
                "sosmed": "@_egistr",
                "kesan": "Disiplin, tangguh, dan penuh tanggung jawab",  
                "pesan":"Teruslah berproses dan berkembang."# 1
            },
            {
                "nama": "Afifah Fauziah",
                "nim": "123450002",
                ...
                "sosmed": "@fifah.zy",
                "kesan": "Kalem tapi juga punya sisi kocak yang bikin suasana jadi hidup.",  
            ...
            },
            {
                ...
                "sosmed": "@biokcb",
                "kesan": "Asik, mudah bergaul, dan selalu bisa bikin suasana jadi seru.",  
                "pesan":"Dunia butuh orang se-asik abang."# 1
            },
            {
                ...
                "hobbi": "Catur",
                "sosmed": "@giofaniars",
                "kesan": "Selalu bisa bikin orang ketawa.",  
            ...
            },
            {
                ...
                "hobbi": "Main catur",
                "sosmed": "@rhmaoktvia",
                "kesan": "Ramah dan penyayang",  
                "pesan":"Semoga ke depan semakin sukses, berkembang, dan terus menjadi inspirasi bagi orang-orang di sekitar."# 1
            },
            {
                ...
                "sosmed": "@gustriana.d_",
                "kesan": "Disiplin, bertanggung jawab",  
                "pesan":"Tetaplah bersinar dengan keceriaan dan kebaikan."# 1
            },
            {
                ...
                "hobbi": "Futsal",
                "sosmed": "@razyn.hfd",
                "kesan": "Asik dan penuh energi positif",  
                "pesan":"Semoga terus sukses."# 1
            },
        ]
        display_images_with_data(gambar_urls, data_list)
    mikfes()
...
if menu == "Departemen Eksternal":
    def eksternal():
        gambar_urls = [
            ...
            "https://drive.google.com/uc?export=view&id=1niC3CZ34r9sr6a1qUl1YRiFxL3i0tnQ_",
            ...
            "https://drive.google.com/uc?export=view&id=1jTQ8gPXE8hIs9bDsZtFwYfw4I-TZN6sS",
            "https://drive.google.com/uc?export=view&id=1shleuAa6VC6Ru2jFNnzxOJlo7FBXjn_q",
            "https://drive.google.com/uc?export=view&id=1u_sGn1jxHfVL2Td7b70Y4PiYgpl0SuX-",
            "https://drive.google.com/uc?export=view&id=1l5q8NCpIX1XrGzY1KsC-UafBlrEphdwB",
            "https://drive.google.com/uc?export=view&id=1BJ_y7nnhPP3NPEdYNXRAY-yz_muXm-du",
            ...
            "https://drive.google.com/uc?export=view&id=1atfUI2wbAIDL1wIwkohbSeqqO-nq-CY8",
            "https://drive.google.com/uc?export=view&id=1TSB_5gTWwqGcLsqQS09nOw-h6hBxMHWs",
        ...
        data_list = [
            {
                ...
                "kesan": "Asik, santai, dan gampang akrab sama siapa aja.",  
            ...
            },
            {
                ...
                "hobbi": "Belajar",
                "sosmed": "@yo_anamnk",
                "kesan": "Ramah, sabar, dan selalu bisa membuat orang sekitarnya merasa nyaman.",  
                "pesan":"Semoga segala impian dan cita-cita kakak tercapai"# 1
            },
            {
                ...
                "hobbi": "Nyetrika baju",
                "sosmed": "@jasminednva",
                "kesan": "Asik banget, selalu punya energi positif",  
                "pesan": "Selalu rendah hati dan penuh semangat"# 1
            },
            {
                ...
                "sosmed": "@elandraa_",
                "kesan": "Ceria, asik, dan selalu bisa membuat suasana jadi lebih hangat.",  
                "pesan":"Semoga segala impian dan harapan kakak tercapai"# 1
            },
            {
                ...
                "kesan": "Humoris dan lucu",  
                "pesan":"Tetap jadi orang yang seru dan penuh energi positif"# 1
            },
            {
                ...
                "kesan": "Perhatian, ramah dan murah senyum",  
                "pesan":"Semangat menjalani kuliahnya setiap hari"# 1
            },
            {
                ...
                "kesan": "Ceria dan penuh tawa",  
                "pesan":"Semoga kesuksesan selalu menyertai langkah kakak"# 1
            },
            {
                ...
                "hobbi": "Jalan - Jalan",
                "sosmed": "@bylaash",
                "kesan": "Super friendly dan gampang akrab",  
                "pesan":"Tetap jadi orang yang penuh tawa dan positif"# 1
            },
            {
                ...
                "kesan": "Tenang, penuh pemikiran, dan bisa diandalkan",  
                "pesan":"Semangat dengan segala hal yang abang kerjakan"# 1
            },
            {
                ...
                "hobbi": "Tidur",
                "sosmed": "@deaa.rsn",
                "kesan": "Humoris, penuh energi dan selalu semangat",  
                "pesan":"Tetap jadi kakak yang ceria dan penuh humor"# 1
            },
            {
                ...
                "sosmed": "@cindylauura",
                "kesan": "Cantik, ramah, sopan",  
                "pesan":"Semoga makin cantik"# 1
            },
            {
                "nama": "Dea Amanda",
                "nim": "123450006",
                ...
                "sosmed": "@deaamnd3_",
                "kesan": "Seru, rame, dan asik",  
                "pesan":"Jangan lupa terus berbagi tawa dan energi positif"# 1
            },
            {
                ...
                "hobbi": "Bermusik",
                "sosmed": "@dsmannhal_",
                "kesan": "Unik, sering melakukan hal tak terduga",  
                "pesan":"Semoga sehat selalu ya bang"# 1
            },
            {
                ...
                "sosmed": "@devynasonyaa",
                "kesan": "Murah senyum, ramah dan baik hati",  
                "pesan":"Semangat untuk jalani hari harinya kak"# 1
            },
            {
            ...
            }, 
            {
                ...
                "kesan": "Berpendirian, dan penuh semangat",  
            ...
            },
            {
                ...
                "sosmed": "@Ty_Tq90",
                "kesan": "Seru, asik, dan pengertian",  
            ...
            },
            {
                ...
                "kesan": "Sangat disiplin dan bededikasi tinggi",  
                "pesan":"Tetaplah jadi pribadi yang bijaksana"# 1
            },
            {
                "nama": "Melinza Nabila",
                "nim": "123450122",
                ...
                "hobbi": "menonton film",
                "sosmed": "@melynznb",
                "kesan": "Cantik, jago dance, ceria dan full energi",  
            ...
            },
            {
                ...
                "hobbi": "Me time",
                "sosmed": "@n.shafirarz",
                "kesan": "Asik, gampang akrab, dan bisa bikin suasana jadi lebih ceria.",  
            ...
            },
            {
                ...
                "hobbi": "Baking",
                "sosmed": "@izzah_tq",
                "kesan": "Ceria dan penuh energi",  
                "pesan":"Sehat selalu"# 1
            },
            {
                "nama": "Qois Olifio",
                "nim": "123450067",
                ...
                "sosmed": "@qoisolifio_",
                "kesan": "Asik walau ga banyak omong",  
                "pesan":"Semoga hidup abang selalu penuh kebahagiaan."# 1
            },
            {
                ...
                "sosmed": "@tari_sya23",
                "kesan": "Super ramah, dan positif vibes",  
                "pesan": "Semoga selalu bahagia"# 1
            },   
...
if menu == "Departemen Internal":
    def internal():
        gambar_urls = [
            ...
            "https://drive.google.com/uc?export=view&id=1mmU_U7LnXX3RbJi1nxImDs4_nv2bTEJQ",
            ...
            "https://drive.google.com/uc?export=view&id=1UwkZQZdd3XlNabuIB5ZpwvZmRB-YpmE8",
            "https://drive.google.com/uc?export=view&id=1b-RyanefVAKyaQz4Y9fITjuWS-BSNGQi",
            ...
            "https://drive.google.com/uc?export=view&id=1hvj9o-48tuYJJycra39GUsfFMpDCPLfc",
            ...
            "https://drive.google.com/uc?export=view&id=1rS047DOKwDf5vUsGNAnmFKHRV64SiAUd",
        ]
        data_list = [
            {
            ...
            },
            {
                ...
                "sosmed": "@renta.shn",
                "kesan": "Cool, pendiam",
                "pesan": "Semoga dipermudahkan segala urusannya"
            },
            {
            ...
            },
            {
                ...
                "hobbi": "Memasak",
                "sosmed": "@azza.rrr_",
                "kesan": "Kiyowo, ceria dan penuh semangat.",
            ...
            },
            {
                ...
                "hobbi": "Balapan",
                "sosmed": "@haikalsbln_",
                "kesan": "Baik, ramah dan penuh tawa.",
                "pesan": "Semangat 45 bang!"
            },
            {
            ...
            },
            {
                ...
                "kesan": "Berpendirian dan bersemangat",
                "pesan": "Semangat 45"
            },
            {
                "nama": "Zailani Satria",
            ...
            
            {
                ...
                "kesan": "Super funny, cute, attractive.",
            ...
            },
            {
                ...
                "sosmed": "@sarahwsti",
                "kesan": "Ramah, baik hati dan penuh percaya diri.",
                "pesan": "Semoga sehat selalu"
            },
    ...
    def medkraf():
        ...
        data_list = [
            ...
            },
            {
                ...
                "kesan": "Murah seyum, dan punya semangat yang tinggi",  
                "pesan":"Tetap semangat 45"# 1
            },
            {
                "nama": "Khoirul Anam",
                "nim": "122450039",
            ...
            },
            {
                ...
                "hobbi": "Motoran",
                "sosmed": "@noerruuu",
                "kesan": "PDD sudah mendarah daging",  
                "pesan":"Semoga selalu semangat ya bang"# 1
            },
            {
            ...
            },
            {
                ...
                "sosmed": "@refadp_",
                "kesan": "Cantik, gemas, dan kiyowo",  
                "pesan":"Tetap menjadi orang yang ceria ya kak"# 1
            },
            {
                ...
                "hobbi": "Belajar",
                "sosmed": "@tryyaniciaaa",
                "kesan": "Cantik, dan sangat kreatif",  
                "pesan":"Semangat mengembangkan ide idenya kak"# 1
            },
            {
