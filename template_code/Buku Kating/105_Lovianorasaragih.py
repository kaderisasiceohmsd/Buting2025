...
if menu == "Baleg":
    def Baleg():
        gambar_urls = [
            "https://drive.google.com/uc?export=download&id=17voXEZcjtitFrV4UaH15PnDSuwZdCLG",
            "https://drive.google.com/uc?export=download&id=1XpEVQeJBEtlOOso8F8hsqrdOkd1ZjV1",
