...
if menu == "Home":
    ...
    def home_page():
        ...
        st.markdown(
            """<div style="text-align: justify;">JACO? BIII!!!!!!.</div>""",
            unsafe_allow_html=True,
        )
        st.write(""" """)
    ...
    def about_page():
        ...
        gambar_urls = [
            ...
            "https://drive.google.com/uc?export=view&id=1225unFJHahU97pNGzKAloGhTZPrwd7Dq", #anggun
            "https://drive.google.com/uc?export=view&id=1DY6TQv1m1EIp5HdACJcd9qKydVfxg0e0", #raisya
