...
if menu == "Home":
    ...
    def home_page():
        ...
        st.markdown(
            """<div style="text-align: justify;">Kelompok Markov adalah kelompok dalam rangkaian pengkaderan mahasiswa Program Studi Sains Data sebelum memasuki keanggotaan himpunan. Terinspirasi dari nama matematikawan Rusia, Andrey Markov, pencetus teori rantai Markov, kelompok ini melambangkan keterhubungan antaranggota serta kesinambungan proses dalam membangun karakter. Dengan semangat ilmiah dan analitis, Kelompok Markov menjadi wadah pembentukan kedisiplinan, solidaritas, serta kesiapan berkontribusi sehingga setiap anggota mampu berkembang baik dalam bidang akademik maupun organisasi.</div>""",
            unsafe_allow_html=True,
        )
        st.write(""" """)
