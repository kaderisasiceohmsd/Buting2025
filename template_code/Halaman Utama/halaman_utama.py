...
if menu == "Home":
    ...
    def home_page():
        ...
        st.markdown(
            """<div style="text-align: justify;">Markov adalah nama kelompok yang diambil dari istilah dalam matematika yaitu proses Markov, yang berarti sebuah sistem yang bergerak maju berdasarkan kondisi saat ini tanpa bergantung pada masa lalu. 
                    Nama ini dipilih karena melambangkan semangat untuk selalu fokus pada langkah yang ada di depan, serta menjadikan setiap pengalaman sebagai pijakan untuk berkembang.
                    Kelompok Markov beranggotakan 12 orang yang masing-masing memiliki peran penting dalam menjaga kekompakan. Seperti proses Markov yang terdiri dari keadaan-keadaan yang saling berhubungan, setiap anggota kelompok saling melengkapi dan membentuk alur kebersamaan.</div>""",
            unsafe_allow_html=True,
        )
        st.write(""" """)
