...
if menu == "Home":
    ...
    def home_page():
        ...
        st.markdown(
            """<div style="text-align: justify;"> Ini adalah kelpompok Anova , paling gacorrr</div>""",
            unsafe_allow_html=True,
        )
        st.write(""" """)
        foto_kelompok = "https://drive.google.com/uc?export=view&id=1GB5DAv1akHYYkrSOZ0gVd837EMTtqWCr"
