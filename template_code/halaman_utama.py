...
def streamlit_menu():
    selected = option_menu(
        ...
        styles={
            "container": {"padding": "0!important", "background-color": "#01fff2"},
            ...
            "nav-link-selected": {"background-color": "#144E5C"},
        },
    )
    return selected
...
if menu == "Home":
    ...
    def home_page():
        ...
        st.markdown(
            """<div style="text-align: justify;"> Testing Deskripsi Anova!!!.</div>""",
            unsafe_allow_html=True,
        )
        st.write(""" """)
        ...
        st.markdown(
            """<div style="text-align: justify;">Kelompok 04 Anova Cihuy!</div>""",
            unsafe_allow_html=True,
        )
        st.write(""" """)
